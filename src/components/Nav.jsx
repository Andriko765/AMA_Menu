  ...
  return (
    <header className=" top-0 fixed bg-[#1d1b20] w-full ">
      <div className="desktop:max-container relative tablet: max-w-[720px]   mx-auto">
            ...
            <ul className=" desktop:flex px-5 py-3  items-center desktop:max-container tablet: max-w-[720px]  tablet:flex hidden   mx-auto ">
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Cider" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Shots" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Alcho" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Pizza" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Hot-Dog" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "Snack" ? " border-b-blue-600" : "border-b-2"
                }`}
              ...
              <li
                className={`cursor-pointer border-b-2 p-3 ${
                  activeLink === "NOAlcho" ? " border-b-blue-600" : "border-b-2"
                }`}
        ...
        <div className=" absolute w-full h-[100dvh]  overflow-hidden bg-slate-400/50 z-10 top-0"></div>
      </div>
    </header>
  );
};
